import napari_labelimg4classification
import pytest

# this is your plugin name declared in your napari.plugins entry point
MY_PLUGIN_NAME = "napari-labelimg4classification"
...
def test_something_with_viewer(widget_name, make_napari_viewer, napari_plugin_manager):
    napari_plugin_manager.register(napari_labelimg4classification, name=MY_PLUGIN_NAME)
